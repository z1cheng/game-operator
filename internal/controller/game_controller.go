...
import (
	...
	myappv1 "chenchen.link/game-operator/api/v1"
)

const (
	gameLabelName = "chenchen.link/game"
	port          = 80
)
...
//+kubebuilder:rbac:groups=myapp.chenchen.link,resources=games,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=myapp.chenchen.link,resources=games/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=myapp.chenchen.link,resources=games/finalizers,verbs=update
